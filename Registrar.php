...
if (isset($_POST['Brigadista'])) {
    $Kerklys['Brigadista'] = $_POST['Brigadista'];
}
...
if (isset($_POST['masOficios'])) {
    $Kerklys['masOficios'] = $_POST['masOficios'];
}
/*if (isset($_POST['telNegocio'])) {
    $Kerklys['telNegocio'] = $_POST['telNegocio'];
}*/
...
$Registrar->RegistrarKerkly1($Kerklys, "ReferenciaTrabajo1", "ReferenciaFamiliar" ,"fotoKerkly" , "INEKerkly" , "curpKERKLY" , "comprobanteDomicilio" , "certificadoMedico" ,"cartaAntePenales","regSatKERKLY" , "comprobanteVacuna" , "fotoDomicilioPart" ,"fotoLocal"/*, $Contrasena*/);
